...
public class Programme_7_SalesCommission {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Entetr Seller ID: ");
        ...
        int grossSalary = basicSalary + salesCommission.calculateComission(salesAmount);
    ...
    //Calculation the sales commission

    public int calculateComission(int salesAmount) {
        int commission;
